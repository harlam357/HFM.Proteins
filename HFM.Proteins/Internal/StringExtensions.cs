...
internal static class StringExtensions
{
    ...
    internal static LineSplitEnumerator SplitLines(this Span<char> str) => new(str);
    ...
    internal ref struct LineSplitEnumerator
    {
        ...
        public bool MoveNext()
        {
            ...
            if (index == -1)
            {
                ...
                Current = new(span, ReadOnlySpan<char>.Empty);
                return true;
            }
            ...
            if (index < span.Length - 1 && span[index] == '\r')
            {
                ...
                if (next == '\n')
                {
                    Current = new(span[..index], span.Slice(index, 2));
                    _str = span[(index + 2)..];
                    return true;
                }
            }

            Current = new(span[..index], span.Slice(index, 1));
            _str = span[(index + 1)..];
            return true;
        }
    ...
    internal static TabSplitEnumerator SplitTabs(this ReadOnlySpan<char> str) => new(str);
