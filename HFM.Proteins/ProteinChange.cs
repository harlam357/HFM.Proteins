...
public class ProteinChange
{
    ...
    /// The protein was not changed.
    /// </summary>
    public static ProteinChange None(int projectNumber) => new(projectNumber, ProteinChangeAction.None, null);

    /// <summary>
    /// The protein was added.
    /// </summary>
    public static ProteinChange Add(int projectNumber) => new(projectNumber, ProteinChangeAction.Add, null);

    /// <summary>
    /// Protein properties were changed.
    /// </summary>
    public static ProteinChange Property(int projectNumber, IEnumerable<ProteinPropertyChange> propertyChanges) =>
        new(projectNumber, ProteinChangeAction.Property, propertyChanges);
